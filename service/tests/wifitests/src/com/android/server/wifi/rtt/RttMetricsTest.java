...
public class RttMetricsTest extends WifiBaseTest {
    ...
    public void testRecordMissingResults() {
        ...
        List<RangingResult> resultMixed25 = getDummyRangingResults(
                WifiRttControllerHal.FRAMEWORK_RTT_STATUS_SUCCESS, requestMixed25, 10, 30);
        // remove some results
    ...
    public void testRecordResultsStatuses() {
        ...
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_SUCCESS, 5);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAILURE, 6);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_NO_RSP, 7);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_REJECTED, 8);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_NOT_SCHEDULED_YET, 9);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_TM_TIMEOUT, 10);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_AP_ON_DIFF_CHANNEL, 11);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_NO_CAPABILITY, 12);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_ABORTED, 13);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_INVALID_TS, 14);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_PROTOCOL, 15);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_SCHEDULE, 16);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_BUSY_TRY_LATER, 17);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_INVALID_REQ, 18);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_NO_WIFI, 19);
        recordResultNTimes(WifiRttControllerHal.FRAMEWORK_RTT_STATUS_FAIL_FTM_PARAM_OVERRIDE, 20);
