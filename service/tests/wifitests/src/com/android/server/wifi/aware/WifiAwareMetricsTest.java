...
public class WifiAwareMetricsTest extends WifiBaseTest {
    ...
    public void testDiscoverySessionMetrics() {
        ...
        mDut.recordDiscoveryStatus(uid1, NanStatusType.SUCCESS, true, sessionId);
        ...
        mDut.recordDiscoveryStatus(uid3, NanStatusType.SUCCESS, true, sessionId);
        ...
        mDut.recordDiscoveryStatus(uid2, NanStatusType.SUCCESS, false, sessionId);
        ...
        mDut.recordDiscoveryStatus(uid3, NanStatusType.SUCCESS, false, sessionId);
    ...
    public void testDataPathMetrics() {
        ...
        setTime(0);
        mDut.recordDiscoveryStatus(uid1, NanStatusType.SUCCESS, true, sessionIds[0]);
        ...
        mDut.recordNdpStatus(NanStatusType.SUCCESS, false, role_init, 5, sessionIds[0], 5120);

        // uid2: ndp (non-secure) on ndi0
        setTime(5);
        mDut.recordDiscoveryStatus(uid1, NanStatusType.SUCCESS, true, sessionIds[1]);
        setTime(7);
        ...
        mDut.recordNdpStatus(NanStatusType.SUCCESS, false, role_resp, 7, sessionIds[1], 2412);

        // uid2: ndp (secure) on ndi1 (OOB)
        setTime(8);
        mDut.recordDiscoveryStatus(uid2, NanStatusType.SUCCESS, true, sessionIds[2]);
        setTime(10);
        ...
        mDut.recordNdpStatus(NanStatusType.SUCCESS, true, role_init, 10, sessionIds[2], 5180);

        // uid2: ndp (secure) on ndi0 (OOB)
        setTime(20);
        mDut.recordDiscoveryStatus(uid2, NanStatusType.SUCCESS, true, sessionIds[3]);
        setTime(25);
        addNetworkInfoToCache(networkRequestCache, 13, uid2, package2, ndi0,
                "super secret password");
        mDut.recordNdpCreation(uid2, package2, networkRequestCache);
        setTime(36); // 11 ms creation time
        mDut.recordNdpStatus(NanStatusType.SUCCESS, true, role_resp, 25, sessionIds[3], 2437);
        ...
        // uid2: ndp (non-secure) on ndi0
        setTime(32);
        mDut.recordDiscoveryStatus(uid2, NanStatusType.SUCCESS, true, sessionIds[4]);
        setTime(36);
        addNetworkInfoToCache(networkRequestCache, 14, uid2, package2, ndi0, null);
        mDut.recordNdpCreation(uid2, package2, networkRequestCache);
        setTime(37); // 1 ms creation time!
        mDut.recordNdpStatus(NanStatusType.SUCCESS, false, role_resp, 36, sessionIds[4], 5180);

        // a few error codes
        mDut.recordNdpStatus(NanStatusType.INTERNAL_FAILURE, false, role_resp, 0, sessionIds[5]);
        mDut.recordNdpStatus(NanStatusType.INTERNAL_FAILURE, false, role_init, 0, sessionIds[6]);
        mDut.recordNdpStatus(NanStatusType.NO_RESOURCES_AVAILABLE, false, role_resp, 0,
                sessionIds[7]);
