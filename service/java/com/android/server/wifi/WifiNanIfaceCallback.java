 ...
 */
public class WifiNanIfaceCallback extends IWifiNanIfaceEventCallback.Stub {
    private static final String TAG = "WifiNanIfaceCallback";

    private boolean mVerboseLoggingEnabled;
    private WifiNanIface mWifiNanIface;

    public WifiNanIfaceCallback(WifiNanIface wifiNanIface) {
