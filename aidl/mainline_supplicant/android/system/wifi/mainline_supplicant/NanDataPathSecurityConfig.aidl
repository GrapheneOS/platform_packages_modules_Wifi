...
parcelable NanDataPathSecurityConfig {
     ...
     * Min length: |ISupplicantNanIface.MIN_DATA_PATH_CONFIG_PASSPHRASE_LENGTH|
     * Max length: |ISupplicantNanIface.MAX_DATA_PATH_CONFIG_PASSPHRASE_LENGTH|
    ...
    /**
     * Enables the 16 replay counter for GTKSA (Group Transient Key security associations), if set
     * to false will use 4 replay counter as default.
     * Wi-Fi Aware spec 4.0: 9.5.21.2 Cipher Suite Information attribute
     */
    boolean enable16ReplyCountersForGtksa;

    /**
     * GTK (Group Transient Key) is used to protect group addressed data frames, IGTK (Integrity
     * Group Transient Key) is used to protect multicast management frames, set to true if
     * supported.
     * Wi-Fi Aware spec 4.0: 9.5.21.2 Cipher Suite Information attribute
     */
    ...
    /**
     * BIGTK (Beacon Integrity Group Transient Key) is used to protect Beacon frames, set to true if
     * supported.
